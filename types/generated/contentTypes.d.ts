...
export interface ApiComboCombo extends Schema.CollectionType {
  ...
  attributes: {
    ...
    cover: Attribute.Media;
    slug: Attribute.UID<'api::combo.combo', 'titulo'>;
...
export interface ApiDisplayCategoriasHomeDisplayCategoriasHome
  extends Schema.SingleType {
  collectionName: 'display_categorias_homes';
  info: {
    singularName: 'display-categorias-home';
    pluralName: 'display-categorias-homes';
    displayName: 'DisplayCategoriasHome';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    categorias: Attribute.Relation<
      'api::display-categorias-home.display-categorias-home',
      'oneToMany',
      'api::categoria.categoria'
    >;
    createdAt: Attribute.DateTime;
...
export interface ApiServicioServicio extends Schema.CollectionType {
  ...
  attributes: {
    ...
    paquetes: Attribute.Component<'paquete.paquetes', true>;
    pantallas: Attribute.Integer &
      Attribute.SetMinMax<{
        min: 0;
      }>;
    categorias: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::display-categorias-home.display-categorias-home': ApiDisplayCategoriasHomeDisplayCategoriasHome;
